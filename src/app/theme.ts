...
function designSystemSemanticVars(palette: ThemePalette, mode: ThemeMode): Record<string, string> {
  return {
    ...
    '--ds-color-button-bg': palette.buttonBackground,
...
function industrialStyleVars(mode: ThemeMode, palette: ThemePalette): Record<string, string> {
  ...
  '--ds-button-danger-soft-bg': palette.dangerBg,
  '--ds-button-danger-soft-text': palette.dangerText,
  '--ds-button-danger-soft-border': 'transparent',
  '--ds-tabs-item-bg-default': palette.buttonBackground,
  '--ds-button-danger-solid-bg': palette.danger,
  '--ds-button-danger-solid-text': palette.dangerContrast,
  '--ds-button-danger-solid-border': palette.danger,
  ...
  '--ds-table-outer-border': palette.border,
  '--ds-table-header-divider': `color-mix(in srgb, ${palette.border} ${mode === 'dark' ? '90%' : '86%'}, transparent)`,
  '--ds-table-row-divider': `color-mix(in srgb, ${palette.border} ${mode === 'dark' ? '66%' : '58%'}, transparent)`,
  '--ds-table-column-divider': 'transparent',
  '--ds-table-fixed-divider': `color-mix(in srgb, ${palette.iconSecondary} 72%, transparent)`,
...
function baseThemeVars(palette: ThemePalette, mode: ThemeMode): Record<string, string> {
  return {
    ...
    '--destructive-foreground': palette.dangerContrast,
...
export function getAppThemeVars(
  ...
  return {
    ...baseThemeVars(THEME_PALETTES[mode], mode),
    ...APP_THEME_VARS[mode],
    ...CURRENT_STYLE_VARS,
...
function robotVars(palette: ThemePalette, mode: ThemeMode): Record<string, string> {
  return {
    ...
    '--robot-danger-contrast': palette.dangerContrast,
